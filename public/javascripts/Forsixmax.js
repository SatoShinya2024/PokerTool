...
let players_card = [dummy, dummy, dummy, dummy, dummy, dummy, dummy, dummy, dummy, dummy, dummy, dummy];
let array_number = 0;
let card_elem;
let clicked = false;
...
const river_line_array = new Array(river_L01, river_L02, river_L03, river_L04, river_L05, river_L06, river_L07, river_L08, river_L09,
                                    ...
                                    river_L30);
/*プレイヤーのアクションの順番の初期値*/
preflop_L01.playerArray = ["UTG", "HJ", "CO", "BTN", "SB"];
...
//プリフロで最後にアクションをするプレイヤー
let last_player = "BB";

/*プリフロアクションの初期値*/
preflop_L01.actionArray = action_array02;

/*文章をセットする行とその次、その前の行の初期値*/
...
const UTG = new player("UTG");const HJ = new player("HJ");const CO = new player("CO");
const BTN = new player("BTN");const SB = new player("SB");const BB = new player("BB");
const All_player = [UTG, HJ, CO, BTN, SB, BB];
//テーブルの初期状態を記録。
let pot;
let minbet;
let minraise;
...
function initialize(){
    ...
    HJ.card1 = players_card[2];
    HJ.card2 = players_card[3];
    CO.card1 = players_card[4];
    CO.card2 = players_card[5];
    BTN.card1 = players_card[6];
    BTN.card2 = players_card[7];
    SB.card1 = players_card[8];
    SB.card2 = players_card[9];
    BB.card1 = players_card[10];
    BB.card2 = players_card[11];
}    
...
function pokertable(ctx){
    ...
    ctx.beginPath();
    ctx.arc(330, 283, 8, 0, Math.PI * 2, false);
    ctx.fill();
    ctx.font = "12px serif";
    ctx.fillStyle = 'rgb(0, 0, 0)';
    ctx.textAlign = "center";
    ctx.fillText("D", 330, 287);
}
//potの描画
...
function draw_player(ctx, player){
    ...
    let personal_name;
    if(player.name == ""){
        personal_name = player.position;
    }else{
        personal_name = player.name;
    }
    ...
    switch(position){	
        case "UTG":
            ...
            ctx.textAlign = 'center';
            ctx.fillText(personal_name, 500, 65);
        ...
        case "HJ":
            ...
            ctx.font = 'italic bold 12px selif';
            ctx.textAlign = 'center';
            ctx.fillText(personal_name, 680, 195);
        ...
        case "CO":
            ...
            ctx.font = 'italic bold 12px selif';
            ctx.textAlign = 'center';
            ctx.fillText(personal_name, 500, 325);
        ...
        case "BTN":
            ...
            ctx.font = 'italic bold 12px selif';
            ctx.textAlign = 'center';
            ctx.fillText(personal_name, 300, 325);
        ...
        case "SB":
            ...
            ctx.font = 'italic bold 12px selif';
            ctx.textAlign = 'center';
            ctx.fillText(personal_name, 120, 195);
        ...
        case "BB":
            ...
            ctx.font = 'italic bold 12px selif';
            ctx.textAlign = 'center';
            ctx.fillText(personal_name, 300, 65);
...
function open_text_dialog(){
    ...
    const players_array = [UTG, HJ, CO, BTN, SB, BB];
    initialize();
...
function submit_form(){
    ...
    //フォームをsubmit
    document.myform.action = "./page05_2_6";
